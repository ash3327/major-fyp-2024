...
subfolder = "Train_Alphabet"
output_dir = "tests/keypoint-stream-1"
...
with mp_hands.Hands(
    ...
    main_dir = os.path.join(data_dir, dataset, subfolder) #"data/raw/synthetic-asl-alphabet/Train_Alphabet"
    landmarks_data = []
    labels_data = []
...
data.to_csv(os.path.join(output_dir, "augmented_hand_landmarks.csv"), index=False)
print("Done!")
